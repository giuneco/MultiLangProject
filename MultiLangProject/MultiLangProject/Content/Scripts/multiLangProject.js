var MultiLangProject = MultiLangProject || {};

MultiLangProject.createNameSpace = function (namespace) {

    //get the namespace string and split it
    var namespaceArr = namespace.split('.');
    var parent = MultiLangProject;

    // excluding the parent
    if (namespaceArr[0] === 'MultiLangProject') {
...
MultiLangProject.createNameSpace("MultiLangProject.Cookies");

MultiLangProject.Cookies.getCookie = function (ck_name) {
...
MultiLangProject.Cookies.setCookie = function (ck_name, value, exdays) {
    var exdate = new Date();
