...
using MultiLangProject.Helpers;
using System;
...
namespace MultiLangProject.Controllers
{
    ...
    {
        private static string _cookieName = "ApplicationLangName";
        public static string GetCultureOnCookiee(HttpRequestBase req)
        {
            var cookie = req.Cookies[_cookieName];
        ...
        {
            string cultureOnCookie = GetCultureOnCookiee(filterContext.HttpContext.Request);
            ...
            {
                filterContext.HttpContext.Response.RedirectToRoute("LangDefault", 
                    new { 
                        lang = culture,
